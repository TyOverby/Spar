...
import com.tyoverby.spar.parsers.genjs.JSTokens._

class JSParserTest extends FlatSpec with Matchers {

  import com.tyoverby.spar.parsers.genjs.GenJsParser.parseProgram
